...
export interface UnblockButtonProps extends HTMLAttributes<HTMLElement> {
	user: User;
}

function UnblockButton({ user, className, style, onClick, ...props }: UnblockButtonProps): ReactElement<UnblockButtonProps> {
