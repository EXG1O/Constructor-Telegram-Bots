    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commands', to='telegram_bots.telegrambot', verbose_name='Telegram бот')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='api_request', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='command', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='database_record', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.ImageField(upload_to=telegram_bots.models.upload_telegram_bot_command_file_path, verbose_name='Файл')),
                ('telegram_bot_command', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=telegram_bots.models.upload_telegram_bot_command_image_path, verbose_name='Изображение')),
                ('telegram_bot_command', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='keyboard', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='telegram_bots.telegrambotcommand')),
                ('telegram_bot_command_keyboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buttons', to='telegram_bots.telegrambotcommandkeyboard')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='message_text', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_bot_command', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='telegram_bots.telegrambotcommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_activity_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата последней активности')),
