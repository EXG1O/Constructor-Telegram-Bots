# Generated by Django 5.0.6 on 2025-01-15 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, max_length=500, null=True, upload_to=telegram_bots.models.base.upload_media_path, verbose_name='Файл')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(verbose_name='Позиция')),
                ('from_url', models.URLField(blank=True, null=True, verbose_name='Из URL-адреса')),
                ('image', models.ImageField(blank=True, max_length=500, null=True, upload_to=telegram_bots.models.base.upload_media_path, verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_token', models.CharField(error_messages={'unique': 'Telegram бот с таким API-токеном уже существует.'}, max_length=50, unique=True, validators=[telegram_bots.models.telegram_bot.validate_api_token], verbose_name='API-токен')),
                ...
                ('must_be_enabled', models.BooleanField(default=False, verbose_name='Должен быть включен')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_handle_position', models.CharField(choices=[('left', 'Слева'), ('right', 'Справа')], max_length=5, verbose_name='Стартовая позиция коннектора')),
                ('target_object_id', models.PositiveBigIntegerField()),
                ('target_handle_position', models.CharField(choices=[('left', 'Слева'), ('right', 'Справа')], max_length=5, verbose_name='Окончательная позиция коннектора')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['source_content_type', 'source_object_id', 'target_content_type', 'target_object_id'], name='telegram_bo_source__bb2efb_idx')],
            },
        ),
    ]
