# Generated by Django 5.0.4 on 2024-04-11 00:52
	...
	operations = [
			...
			fields=[
				...
				(
					...
					models.PositiveSmallIntegerField(
						choices=[(1, '1 день'), (3, '3 дня'), (7, '7 дней'), (14, '14 дней'), (28, '28 дней')],
			...
			fields=[
				...
				(
					...
					models.OneToOneField(
						...
						to='telegram_bots.backgroundtask',
						verbose_name='Фоновая задача',
					),
				),
			],
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'file',
					models.ImageField(upload_to=telegram_bots.models.upload_command_file_path, verbose_name='Файл'),
				),
				(
					'command',
					models.ForeignKey(
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'image',
					models.ImageField(
						upload_to=telegram_bots.models.upload_command_image_path, verbose_name='Изображение'
					),
				),
				(
					'command',
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'type',
					models.CharField(
						choices=[('default', 'Обычный'), ('inline', 'Встроенный'), ('payment', 'Платёжный')],
						default='default',
						max_length=7,
						verbose_name='Режим',
					),
			...
			fields=[
				...
				(
					...
					models.ForeignKey(
						...
						to='telegram_bots.commandkeyboard',
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.BooleanField(default=False, verbose_name='Ответить на сообщение пользователя'),
				),
				(
					'is_delete_user_message',
					models.BooleanField(default=False, verbose_name='Удалить сообщение пользователя'),
				),
				(
					'is_send_as_new_message',
					models.BooleanField(default=False, verbose_name='Отправить сообщение как новое'),
				),
				(
					'command',
					models.OneToOneField(
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'type',
					models.CharField(
						choices=[('+', 'Положительный'), ('-', 'Отрицательный')], max_length=1, verbose_name='Тип'
					),
				),
				...
				(
					...
					models.CharField(
						...
						max_length=2,
						null=True,
						verbose_name='Оператор для следующей части',
					),
				),
				(
					'condition',
			...
			fields=[
				...
				(
					...
					models.CharField(
						max_length=50,
						unique=True,
						validators=[telegram_bots.models.validate_api_token],
			...
			fields=[
				...
				(
					...
					models.CharField(
						...
						default='left',
						max_length=5,
						verbose_name='Стартовая позиция коннектора',
					),
				),
				...
				(
					...
					models.CharField(
						...
						default='right',
						max_length=5,
						verbose_name='Окончательная позиция коннектора',
					),
				),
				(
					'source_content_type',
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'last_activity_date',
					models.DateTimeField(auto_now_add=True, verbose_name='Дата последней активности'),
				),
