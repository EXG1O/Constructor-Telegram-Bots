{
	...
	function telegramBotCommandAddKeyboardButton(
		...
		telegramBotCommandKeyboardButtonDelete.addEventListener('click', function() {
			...
			telegramBotCommand.additions.keyboard.buttons.querySelectorAll(`.telegram-bot-command-keyboard-button-row-button[id="${telegramBotCommandKeyboardRow.innerHTML}"]`).forEach(telegramBotCommandKeyboardButtonRowButton => telegramBotCommandKeyboardButtonRowButton.remove());
	...
	function editTelegramBotCommand(telegramBotCommand_) {
		...
		if (telegramBotCommand_['database_record'] != null) {
			...
			telegramBotCommand.additions.databaseRecord.dataInput.value = telegramBotCommand_['database_record'];
		}
	...
	telegramBotCommand.addOrEditButton.addEventListener('click', function() {
		...
		if (telegramBotCommand.additions.databaseRecord.div.classList.contains('d-none') == false) {
			telegramBotCommandData_['database_record'] = telegramBotCommand.additions.databaseRecord.dataInput.value;
		}
