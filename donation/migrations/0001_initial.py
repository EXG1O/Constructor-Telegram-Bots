			...
			fields=[
				...
				(
					...
					models.PositiveSmallIntegerField(
						blank=True, default=donation.models.button_position_default, verbose_name='Позиция'
					),
				),
			],
			options={
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					'position',
					models.PositiveSmallIntegerField(
						blank=True, default=donation.models.section_position_default, verbose_name='Позиция'
					),
				),
			],
			options={
