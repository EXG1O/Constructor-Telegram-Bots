...
class TelegramBotAPIView(RetrieveUpdateAPIView):
...
class TelegramBotCommandsAPIView(ListAPIView):
	authentication_classes = [TokenAuthentication]
	permission_classes = [IsAuthenticated & TelegramBotIsFound]
...
class TelegramBotCommandAPIView(RetrieveAPIView):
	authentication_classes = [TokenAuthentication]
...
class TelegramBotVariablesAPIView(ListAPIView):
	authentication_classes = [TokenAuthentication]
	permission_classes = [IsAuthenticated & TelegramBotIsFound]
...
class TelegramBotUsersAPIView(CreateAPIView):
	authentication_classes = [TokenAuthentication]
	permission_classes = [IsAuthenticated & TelegramBotIsFound]
