...
class KonstruktorTestCase(TestCase):
	...
	def test_successfully_main_konstruktor_page_1(self):
		self.auth_user()

		response = self.client.get('/konstruktor/Test/')
		self.assertEqual(response.status_code, 200)

	def test_successfully_main_konstruktor_page_2(self):
		self.auth_user(user_group='paid_accounts')

		response = self.client.get('/konstruktor/Test/')
		self.assertEqual(response.status_code, 200)

	def test_fail_main_konstruktor_page(self):
		self.auth_user()

		response = self.client.get('/konstruktor/Fail/')
		self.assertEqual(response.status_code, 400)

	def test_add_bot_page(self):
		self.auth_user()

		response = self.client.get('/konstruktor/Test/add_bot/')
		self.assertEqual(response.status_code, 200)
	...
	def test_successfully_delete_bot(self):
		...
		self.client.post('/konstruktor/Test/add_bot_/', data, content_type='application/json')

		data = {
			'bot_id': 1
		}
		response = self.client.post('/konstruktor/Test/delete_bot/', data, content_type='application/json')
	...
	def test_successfully_add_bot_1(self):
		...
		response = self.client.post('/konstruktor/Test/add_bot_/', data, content_type='application/json')
		response_text = response.content.decode('UTF-8')
	...
	def test_successfully_view_konstruktor_bot_page_1(self):
		self.auth_user()
		...
		response = self.client.get('/konstruktor/Test/view_bot/1/')
		self.assertEqual(response.status_code, 200)

	def test_successfully_view_konstruktor_bot_page_2(self):
		self.auth_user(user_group='paid_accounts')
	...
	def test_fail_view_konstruktor_bot_page(self):
		self.auth_user()

		response = self.client.get('/konstruktor/Test/view_bot/10/')
		self.assertEqual(response.status_code, 302)
	...
	def test_successfully_save_bot_settings(self):
		...
		response = self.client.post('/konstruktor/Test/view_bot/1/save_bot_settings/', data, content_type='application/json')
		response_text = response.content.decode('UTF-8')
	...
	def test_successfully_clear_log(self):
		...
		response = self.client.post('/konstruktor/Test/view_bot/1/clear_log/')
		response_text = response.content.decode('UTF-8')
	...
	def test_successfully_add_command_page(self):
		...
		response = self.client.get('/konstruktor/Test/view_bot/1/add_command/')
		self.assertEqual(response.status_code, 200)
	...
	def test_successfully_add_command_1(self):
		...
		response = self.client.post('/konstruktor/Test/view_bot/1/add_command_/', data, content_type='application/json')
		response_text = response.content.decode('UTF-8')
	...
	def test_successfully_add_command_2(self):
		...
		for i in range(15):
			...
			self.client.post('/konstruktor/Test/view_bot/1/add_command_/', data, content_type='application/json')
	...
	def test_successfully_view_command_page(self):
		...
		response = self.client.get('/konstruktor/Test/view_bot/1/view_command/1/')
		self.assertEqual(response.status_code, 200)
	...
	def test_successfully_save_command(self):
		...
		response = self.client.post('/konstruktor/Test/view_bot/1/view_command/1/save_command/', data, content_type='application/json')
		response_text = response.content.decode('UTF-8')
	...
	def test_successfully_delete_command(self):
		...
		response = self.client.post('/konstruktor/Test/view_bot/1/view_command/1/delete_command/')
		response_text = response.content.decode('UTF-8')
