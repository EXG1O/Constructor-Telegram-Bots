...
urlpatterns = [
	...
	path('konstruktor/<str:nickname>/view_bot/<str:bot_name>/add_command/', add_command_page),
	path('konstruktor/<str:nickname>/view_bot/<str:bot_name>/add_command_/', add_command)
]
